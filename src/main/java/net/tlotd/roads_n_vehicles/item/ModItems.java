...
public class ModItems {
    //public static final Item MUSCLE_CAR_STALLION = registerItem("muscle_car_stallion", new SpawnEggItem(ModEntities.MUSCLE_CAR_STALLION, 0xffffff, 0xffffff, new Item.Properties()));
    //public static final Item MUSCLE_CAR_FIRECHARGE = registerItem("muscle_car_firecharge", new SpawnEggItem(ModEntities.MUSCLE_CAR_FIRECHARGE, 0xffffff, 0xffffff, new Item.Properties()));
    public static final Item MUSCLE_CAR_STALLION = registerItem("muscle_car_stallion", new Item(new Item.Properties().stacksTo(1)));
    public static final Item MUSCLE_CAR_FIRECHARGE = registerItem("muscle_car_firecharge", new Item(new Item.Properties().stacksTo(1)));
