...
public class MuscleCarStallionModel<T extends MuscleCarEntity> extends SinglePartEntityModel<T> {
	private final ModelPart muscle_car_stallion;

	public MuscleCarStallionModel(ModelPart root) {
		this.muscle_car_stallion = root.getChild("muscle_car_stallion");
	}

	public static TexturedModelData getTexturedModelData() {
		ModelData modelData = new ModelData();
		ModelPartData modelPartData = modelData.getRoot();
		ModelPartData muscle_car_stallion = modelPartData.addChild("muscle_car_stallion", ModelPartBuilder.create().uv(0, 58).cuboid(14.25F, -11.0F, 9.0F, 1.0F, 3.0F, 1.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r1 = muscle_car_stallion.addChild("cube_r1", ModelPartBuilder.create().uv(192, 132).cuboid(13.5F, -19.25F, -18.0F, 4.0F, 3.0F, 1.0F, new Dilation(0.0F))
				.uv(26, 38).cuboid(12.0F, -17.25F, -19.0F, 4.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, 3.0F, 46.0F, 0.0F, -0.3927F, 0.0F));

		ModelPartData cube_r2 = muscle_car_stallion.addChild("cube_r2", ModelPartBuilder.create().uv(26, 108).cuboid(-16.0F, -17.25F, -19.0F, 4.0F, 1.0F, 1.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r3 = muscle_car_stallion.addChild("cube_r3", ModelPartBuilder.create().uv(44, 140).cuboid(-1.0F, -6.0F, -6.0F, 2.0F, 2.0F, 7.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, 0.0F, 50.0F, -0.3927F, 0.0F, 0.0F));

		ModelPartData cube_r4 = muscle_car_stallion.addChild("cube_r4", ModelPartBuilder.create().uv(0, 58).cuboid(12.5F, 5.0F, -25.0F, 1.0F, 1.0F, 4.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r5 = muscle_car_stallion.addChild("cube_r5", ModelPartBuilder.create().uv(141, 181).cuboid(3.0F, -17.5F, -1.0F, 12.0F, 12.0F, 3.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r6 = muscle_car_stallion.addChild("cube_r6", ModelPartBuilder.create().uv(142, 159).cuboid(-4.5F, -22.0F, -11.0F, 1.0F, 7.0F, 1.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r7 = muscle_car_stallion.addChild("cube_r7", ModelPartBuilder.create().uv(36, 104).cuboid(-11.0F, -12.5F, -14.5F, 1.0F, 5.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(7.0F, 0.0F, 52.0F, 0.3927F, 0.0F, 1.0472F));

		ModelPartData cube_r8 = muscle_car_stallion.addChild("cube_r8", ModelPartBuilder.create().uv(39, 125).cuboid(10.0F, -12.5F, -14.5F, 1.0F, 5.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(7.0F, 0.0F, 52.0F, 0.3927F, 0.0F, -1.0472F));

		ModelPartData cube_r9 = muscle_car_stallion.addChild("cube_r9", ModelPartBuilder.create().uv(0, 0).cuboid(-0.5F, -19.75F, -15.25F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(7.0F, 0.0F, 52.0F, 0.1963F, 0.0F, 0.0F));

		ModelPartData cube_r10 = muscle_car_stallion.addChild("cube_r10", ModelPartBuilder.create().uv(129, 95).cuboid(-17.5F, -18.4F, 2.3F, 35.0F, 5.0F, 1.0F, new Dilation(0.0F))
				.uv(120, 132).cuboid(-17.5F, 7.6F, -21.7F, 35.0F, 7.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, 0.0F, 52.0F, -0.7854F, 0.0F, 0.0F));

		ModelPartData cube_r11 = muscle_car_stallion.addChild("cube_r11", ModelPartBuilder.create().uv(68, 168).cuboid(-19.5F, -9.41F, 15.08F, 5.0F, 3.0F, 2.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r12 = muscle_car_stallion.addChild("cube_r12", ModelPartBuilder.create().uv(22, 177).cuboid(-19.5F, 7.5F, 12.99F, 5.0F, 2.0F, 3.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r13 = muscle_car_stallion.addChild("cube_r13", ModelPartBuilder.create().uv(199, 31).cuboid(-19.5F, 10.59F, 17.54F, 6.0F, 3.0F, 2.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r14 = muscle_car_stallion.addChild("cube_r14", ModelPartBuilder.create().uv(148, 166).cuboid(-19.5F, -12.5F, 18.65F, 6.0F, 2.0F, 3.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r15 = muscle_car_stallion.addChild("cube_r15", ModelPartBuilder.create().uv(44, 140).cuboid(-6.0F, -37.15F, -31.1F, 1.0F, 5.0F, 1.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r16 = muscle_car_stallion.addChild("cube_r16", ModelPartBuilder.create().uv(55, 140).cuboid(5.0F, -37.15F, -31.1F, 1.0F, 5.0F, 1.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r17 = muscle_car_stallion.addChild("cube_r17", ModelPartBuilder.create().uv(118, 185).cuboid(16.15F, -10.25F, -8.5F, 1.0F, 4.0F, 12.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, 0.0F, 52.0F, 0.0F, -0.1963F, 0.0F));

		ModelPartData cube_r18 = muscle_car_stallion.addChild("cube_r18", ModelPartBuilder.create().uv(63, 188).cuboid(-17.15F, -10.25F, -8.5F, 1.0F, 4.0F, 12.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, 0.0F, 52.0F, 0.0F, 0.1963F, 0.0F));

		ModelPartData cube_r19 = muscle_car_stallion.addChild("cube_r19", ModelPartBuilder.create().uv(0, 89).cuboid(19.25F, -19.25F, 3.0F, 1.0F, 3.0F, 6.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, 0.0F, 52.0F, 0.0F, -0.1745F, 0.0F));

		ModelPartData cube_r20 = muscle_car_stallion.addChild("cube_r20", ModelPartBuilder.create().uv(42, 93).cuboid(-20.25F, -19.25F, 3.0F, 1.0F, 3.0F, 6.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, 0.0F, 52.0F, 0.0F, 0.1745F, 0.0F));

		ModelPartData cube_r21 = muscle_car_stallion.addChild("cube_r21", ModelPartBuilder.create().uv(38, 132).cuboid(-18.5F, -3.26F, -52.25F, 1.0F, 1.0F, 26.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r22 = muscle_car_stallion.addChild("cube_r22", ModelPartBuilder.create().uv(0, 134).cuboid(3.5F, -23.0F, -21.0F, 7.0F, 1.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, -1.0F, 53.0F, 0.0F, -0.3927F, 0.0F));

		ModelPartData cube_r23 = muscle_car_stallion.addChild("cube_r23", ModelPartBuilder.create().uv(44, 149).cuboid(-10.5F, -23.0F, -21.0F, 7.0F, 1.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, -1.0F, 53.0F, 0.0F, 0.3927F, 0.0F));

		ModelPartData cube_r24 = muscle_car_stallion.addChild("cube_r24", ModelPartBuilder.create().uv(104, 65).cuboid(-18.5F, -21.1F, -15.8F, 37.0F, 1.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, 0.0F, 104.0F, 0.3927F, 0.0F, 0.0F));

		ModelPartData cube_r25 = muscle_car_stallion.addChild("cube_r25", ModelPartBuilder.create().uv(30, 75).cuboid(17.5F, -19.75F, 32.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r26 = muscle_car_stallion.addChild("cube_r26", ModelPartBuilder.create().uv(36, 70).cuboid(-15.0F, -12.0F, 31.0F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r27 = muscle_car_stallion.addChild("cube_r27", ModelPartBuilder.create().uv(74, 41).cuboid(14.0F, -12.0F, 31.0F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r28 = muscle_car_stallion.addChild("cube_r28", ModelPartBuilder.create().uv(108, 26).cuboid(-18.5F, 10.4F, -37.6F, 37.0F, 4.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, 0.0F, 104.0F, -0.5236F, 0.0F, 0.0F));

		ModelPartData cube_r29 = muscle_car_stallion.addChild("cube_r29", ModelPartBuilder.create().uv(108, 32).cuboid(-18.5F, 25.4F, -26.7F, 37.0F, 4.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, 0.0F, 104.0F, -1.0472F, 0.0F, 0.0F));

		ModelPartData cube_r30 = muscle_car_stallion.addChild("cube_r30", ModelPartBuilder.create().uv(128, 109).cuboid(-54.5F, -20.5F, -19.9F, 37.0F, 3.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(34.0F, 0.0F, 104.0F, 0.5236F, 0.0F, 0.0F));

		ModelPartData cube_r31 = muscle_car_stallion.addChild("cube_r31", ModelPartBuilder.create().uv(128, 114).cuboid(-54.5F, -29.5F, -7.4F, 37.0F, 3.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(34.0F, 0.0F, 104.0F, 1.0472F, 0.0F, 0.0F));

		ModelPartData cube_r32 = muscle_car_stallion.addChild("cube_r32", ModelPartBuilder.create().uv(128, 119).cuboid(-54.5F, -29.5F, -7.4F, 37.0F, 3.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(34.0F, 0.0F, 52.0F, 1.0472F, 0.0F, 0.0F));

		ModelPartData cube_r33 = muscle_car_stallion.addChild("cube_r33", ModelPartBuilder.create().uv(128, 103).cuboid(-18.5F, 25.4F, -26.7F, 37.0F, 4.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, 0.0F, 52.0F, -1.0472F, 0.0F, 0.0F));

		ModelPartData cube_r34 = muscle_car_stallion.addChild("cube_r34", ModelPartBuilder.create().uv(185, 192).cuboid(-8.0F, -18.25F, -42.2F, 16.0F, 4.0F, 1.0F, new Dilation(0.0F))
				.uv(173, 192).cuboid(-2.5F, -25.25F, -42.2F, 5.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, -4.0F, 52.0F, 0.3927F, 0.0F, 0.0F));

		ModelPartData cube_r35 = muscle_car_stallion.addChild("cube_r35", ModelPartBuilder.create().uv(23, 159).cuboid(3.5F, -2.9F, -29.0F, 9.0F, 1.0F, 1.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r36 = muscle_car_stallion.addChild("cube_r36", ModelPartBuilder.create().uv(0, 38).cuboid(-6.0F, -6.75F, -47.82F, 12.0F, 1.0F, 1.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r37 = muscle_car_stallion.addChild("cube_r37", ModelPartBuilder.create().uv(0, 108).cuboid(-6.0F, -6.75F, -47.82F, 12.0F, 1.0F, 1.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r38 = muscle_car_stallion.addChild("cube_r38", ModelPartBuilder.create().uv(59, 140).cuboid(-0.5F, -37.25F, -30.52F, 1.0F, 5.0F, 1.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r39 = muscle_car_stallion.addChild("cube_r39", ModelPartBuilder.create().uv(138, 159).cuboid(-0.5F, -37.25F, -30.52F, 1.0F, 5.0F, 1.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r40 = muscle_car_stallion.addChild("cube_r40", ModelPartBuilder.create().uv(39, 114).cuboid(-0.5F, -37.25F, -30.8F, 1.0F, 6.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, -1.0F, 53.0F, 0.7854F, 0.0F, 0.0F));

		ModelPartData cube_r41 = muscle_car_stallion.addChild("cube_r41", ModelPartBuilder.create().uv(0, 29).cuboid(-0.5F, -17.0F, -23.2F, 1.0F, 3.0F, 1.0F, new Dilation(0.0F))
				.uv(54, 80).cuboid(-16.5F, -19.5F, -28.0F, 1.0F, 13.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, 0.0F, 52.0F, -0.2618F, 0.0F, 0.0F));

		ModelPartData cube_r42 = muscle_car_stallion.addChild("cube_r42", ModelPartBuilder.create().uv(91, 149).cuboid(-5.5F, -27.75F, -42.25F, 12.0F, 5.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, -3.0F, 53.0F, 0.3927F, 0.1309F, 0.0F));

		ModelPartData cube_r43 = muscle_car_stallion.addChild("cube_r43", ModelPartBuilder.create().uv(185, 197).cuboid(-6.5F, -27.75F, -42.25F, 12.0F, 5.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, -3.0F, 53.0F, 0.3927F, -0.1309F, 0.0F));

		ModelPartData cube_r44 = muscle_car_stallion.addChild("cube_r44", ModelPartBuilder.create().uv(118, 169).cuboid(-0.5F, -27.75F, -42.65F, 1.0F, 5.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, -3.0F, 53.0F, 0.3927F, 0.0F, 0.0F));

		ModelPartData cube_r45 = muscle_car_stallion.addChild("cube_r45", ModelPartBuilder.create().uv(0, 35).cuboid(3.5F, -23.0F, -21.0F, 8.0F, 1.0F, 1.0F, new Dilation(0.0F))
				.uv(23, 198).cuboid(-6.5F, -6.25F, -47.25F, 8.0F, 1.0F, 5.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, 0.0F, 52.0F, 0.0F, -0.3927F, 0.0F));

		ModelPartData cube_r46 = muscle_car_stallion.addChild("cube_r46", ModelPartBuilder.create().uv(124, 169).cuboid(-11.5F, -23.0F, -21.0F, 8.0F, 1.0F, 1.0F, new Dilation(0.0F))
				.uv(199, 25).cuboid(-1.5F, -6.25F, -47.25F, 8.0F, 1.0F, 5.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, 0.0F, 52.0F, 0.0F, 0.3927F, 0.0F));

		ModelPartData cube_r47 = muscle_car_stallion.addChild("cube_r47", ModelPartBuilder.create().uv(108, 0).cuboid(10.25F, -15.25F, -45.0F, 7.0F, 1.0F, 25.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, 0.0F, 52.0F, 0.0F, 0.0F, 0.0873F));

		ModelPartData cube_r48 = muscle_car_stallion.addChild("cube_r48", ModelPartBuilder.create().uv(0, 114).cuboid(-17.25F, -15.25F, -45.0F, 7.0F, 1.0F, 25.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, 0.0F, 52.0F, 0.0F, 0.0F, -0.0873F));

		ModelPartData cube_r49 = muscle_car_stallion.addChild("cube_r49", ModelPartBuilder.create().uv(39, 122).cuboid(-6.0F, -6.25F, -47.32F, 12.0F, 1.0F, 2.0F, new Dilation(0.0F))
				.uv(62, 180).cuboid(-6.0F, -5.25F, -47.82F, 12.0F, 1.0F, 7.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, -8.0F, 50.0F, 0.0F, 0.1309F, 0.0F));

		ModelPartData cube_r50 = muscle_car_stallion.addChild("cube_r50", ModelPartBuilder.create().uv(23, 155).cuboid(-6.0F, -6.25F, -47.32F, 12.0F, 1.0F, 2.0F, new Dilation(0.0F))
				.uv(39, 114).cuboid(-6.0F, -5.25F, -47.82F, 12.0F, 1.0F, 7.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, -8.0F, 50.0F, 0.0F, -0.1309F, 0.0F));

		ModelPartData cube_r51 = muscle_car_stallion.addChild("cube_r51", ModelPartBuilder.create().uv(0, 156).cuboid(-7.0F, -7.25F, -47.0F, 7.0F, 1.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, -8.0F, 50.0F, 0.0F, -0.3927F, 0.0873F));

		ModelPartData cube_r52 = muscle_car_stallion.addChild("cube_r52", ModelPartBuilder.create().uv(148, 162).cuboid(0.0F, -7.25F, -47.0F, 7.0F, 1.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, -8.0F, 50.0F, 0.0F, 0.3927F, -0.0873F));

		ModelPartData cube_r53 = muscle_car_stallion.addChild("cube_r53", ModelPartBuilder.create().uv(104, 41).cuboid(5.0F, -30.4F, -41.25F, 1.0F, 5.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, 0.0F, 52.0F, 0.3927F, -0.1309F, 0.0F));

		ModelPartData cube_r54 = muscle_car_stallion.addChild("cube_r54", ModelPartBuilder.create().uv(104, 49).cuboid(-6.0F, -30.4F, -41.25F, 1.0F, 5.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, 0.0F, 52.0F, 0.3927F, 0.1309F, 0.0F));

		ModelPartData cube_r55 = muscle_car_stallion.addChild("cube_r55", ModelPartBuilder.create().uv(168, 181).cuboid(-6.0F, -6.25F, -47.32F, 12.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, -1.0F, 53.0F, 0.0F, 0.1309F, 0.0F));

		ModelPartData cube_r56 = muscle_car_stallion.addChild("cube_r56", ModelPartBuilder.create().uv(188, 55).cuboid(-6.0F, -6.25F, -47.32F, 12.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, -1.0F, 53.0F, 0.0F, -0.1309F, 0.0F));

		ModelPartData lights_r1 = muscle_car_stallion.addChild("lights_r1", ModelPartBuilder.create().uv(36, 85).cuboid(-17.9F, 5.52F, -43.0F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
		...
		ModelPartData lights_r2 = muscle_car_stallion.addChild("lights_r2", ModelPartBuilder.create().uv(80, 63).cuboid(-4.0F, -20.0F, -43.0F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
		...
		ModelPartData lights_r3 = muscle_car_stallion.addChild("lights_r3", ModelPartBuilder.create().uv(108, 18).cuboid(-4.25F, -35.0F, -30.0F, 2.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, 0.0F, 52.0F, 0.7854F, -0.3927F, 0.0F));

		ModelPartData lights_r4 = muscle_car_stallion.addChild("lights_r4", ModelPartBuilder.create().uv(29, 140).cuboid(1.75F, -35.0F, -30.0F, 2.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, 0.0F, 52.0F, 0.7854F, 0.3927F, 0.0F));
		return TexturedModelData.of(modelData, 256, 256);
	}
	@Override
	public void render(MatrixStack matrices, VertexConsumer vertexConsumer, int light, int overlay, float red, float green, float blue, float alpha) {
		muscle_car_stallion.render(matrices, vertexConsumer, light, overlay, red, green, blue, alpha);
	}

	@Override
	public ModelPart getPart() {
		return muscle_car_stallion;
	}
