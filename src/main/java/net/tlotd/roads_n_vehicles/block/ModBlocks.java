...
public class ModBlocks {
    ...
    public static final Block MANHOLE_COVER = registerBlock("manhole_cover",
            new ManholeCoverBlock(FabricBlockSettings.create().mapColor(MapColor.GRAY).requiresTool().strength(2.0F, 3.0F).velocityMultiplier(1.25F), BlockSetType.POLISHED_BLACKSTONE));

    public static final Block IRON_ROD = registerBlock("iron_rod",
            new ModRodBlock(FabricBlockSettings.create().mapColor(MapColor.GRAY).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).nonOpaque()));
    ...
    public static final Block SMALL_ROUTE_NUMBER_SIGN = registerBlock("small_route_number_sign",
            new SmallRouteNumberSignBlock(FabricBlockSettings.create().mapColor(MapColor.GRAY).requiresTool().strength(2.0F, 3.0F).sounds(BlockSoundGroup.METAL).nonOpaque()));
    ...
    public static final Block HORIZONTAL_SIGN = registerBlock("horizontal_sign",
            new HorizontalSignBlock(FabricBlockSettings.create().mapColor(MapColor.GRAY).requiresTool().strength(2.0F, 3.0F).sounds(BlockSoundGroup.METAL).nonOpaque()));
