...
public class ModBlockEntities {
    ...
    public static final BlockEntityType<LicensePlateBlockEntity> LICENSE_PLATE =
            Registry.register(
                    ...
                    ResourceLocation.fromNamespaceAndPath(TLOTDRoadsnVehicles.MOD_ID, "license_plate"),
    ...
    public static final BlockEntityType<TownSignBlockEntity> TOWN_SIGN =
            Registry.register(
                    BuiltInRegistries.BLOCK_ENTITY_TYPE,
                    ResourceLocation.fromNamespaceAndPath(TLOTDRoadsnVehicles.MOD_ID, "town_sign"),
                    BlockEntityType.Builder.of(
